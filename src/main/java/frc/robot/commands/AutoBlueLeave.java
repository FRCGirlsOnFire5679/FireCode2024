 ...
 *
 */
public class AutoBlueLeave extends Command {
    ...
    public AutoBlueLeave(DriveTrain subsystem, DriveMethods subDriveMethods) {
    ...
    public void execute() {
        while (num < 1){
            ...
            m_DriveMethods.driveForward(1.2);
            m_DriveMethods.driveTurnR(0.55);
             m_DriveMethods.driveForward(0.5);
            num ++;
        }
