 ...
 *
 */
public class AutoBlueShoot1 extends Command {
    ...
    public AutoBlueShoot1(DriveTrain subsystem, DriveMethods subDriveMethods) {
    ...
    public void execute() {
        while (num < 1){
            ...
            m_DriveMethods.driveForward(0.2);
            m_DriveMethods.driveTurnL(0.25);
            m_DriveMethods.driveBackwards(.8);
            num ++;
        }
