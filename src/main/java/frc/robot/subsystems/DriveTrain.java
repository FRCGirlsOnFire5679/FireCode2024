...
public class DriveTrain extends SubsystemBase {
    ...
    */
    public DriveTrain() {
        ...
        frontLeftController.addFollower(rearLeftController);
        frontRightController.addFollower(rearRightController);

        robotDrive = new DifferentialDrive(frontLeftController, frontRightController);
